...
ssh -i /Users/tomas/.ssh/id_rsa tommarik15@34.159.198.249 "
    sudo find /home/tommarik15/notado/frontend/ -mindepth 1 \
        ! -path '/home/tommarik15/notado/frontend/resources/*' \
        ! -path '/home/tommarik15/notado/frontend/media/*' \
        ! -name 'resources' \
        ! -name 'media' \
        ! -name '.htaccess' \
        -delete
...
sudo rsync -avz --exclude 'resources/' --exclude 'media/' \
    ...
    tommarik15@34.159.198.249:/home/tommarik15/notado/frontend/
...
sudo rsync -avz -e "ssh -i /Users/tomas/.ssh/id_rsa" \
    ...
    tommarik15@34.159.198.249:/home/tommarik15/notado/frontend/assets/

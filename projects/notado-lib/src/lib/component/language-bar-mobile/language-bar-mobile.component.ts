...
@Component({
  selector: 'app-language-bar-mobile',
  templateUrl: './language-bar-mobile.component.html',
  styleUrls: ['./language-bar-mobile.component.scss'],
  imports: [
    NgForOf
  ],
  standalone: true
})
export class LanguageBarMobileComponent implements OnInit {

...
@Component({
  ...
  templateUrl: './intro-module.component.html',
  styleUrls: ['./intro-module.component.scss'],
  imports: [
    MenuComponent,
    NgIf,
    MenuSimpleComponent,
...
export class IntroModuleComponent extends MySubscribable implements OnInit {

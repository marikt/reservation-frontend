...
@Component({
  selector: 'app-integration-smsmanager',
  templateUrl: './integration-smsmanager.component.html',
  styleUrls: ['./integration-smsmanager.component.scss'],
  imports: [
...
export class IntegrationSmsmanagerComponent extends IntegrationCoreComponent {

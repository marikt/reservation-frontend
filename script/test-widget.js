...
var yWidget = {
  ...
  id: '676543',
  href: 'https://n676543.yclients.com/',
  script_href: 'https://w676543.yclients.com/',
  lang: 'rus',
  isNew: '1',
  ...
  loadSuperButton: function() {
    ...
    window.yClientsWidgetOptions = {
      target: outlet,
      widgetBaseUrl: 'https://n676543.yclients.com',
      companyId: '599772',
      widgetId: '676543',
    ...
    link.setAttribute('href', 'https://n676543.yclients.com/superbutton/superbutton.css');
    document.head.appendChild(link);

    var script = document.createElement('script');
    script.setAttribute('src', 'https://n676543.yclients.com/superbutton/superbutton.umd.min.js');
